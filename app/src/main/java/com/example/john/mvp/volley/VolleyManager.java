package com.example.john.mvp.volley;
...
import com.example.john.mvp.Application.MyApplication;
...
public class VolleyManager {
    ...
    private static class VolleyManagerHolder {
        private static final VolleyManager INSTANCE = new VolleyManager(MyApplication.getContext());
    }
